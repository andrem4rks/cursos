...
public class PetService {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = requestService.dispararRequisicaoGet(client, uri);
    ...
    public void importarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            String cor = campos[4];
            Float peso = Float.valueOf(campos[5]);
            ...
            HttpResponse<String> response = requestService.dispararRequisicaoPost(client, uri, json);
            int statusCode = response.statusCode();
            String responseBody = response.body();
            if (statusCode == 200) {
